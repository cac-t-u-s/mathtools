...
(defmethod! t-primeform-n ((pcset t) n)
  :icon 131
  :doc
...
(defmethod! transp-comb ((a t) tid n)
    :initvals '((0 3 6 9) (0 1) 12) :indoc '("first set" "second set" "n")
    :doc "It makes the transpositional combination or chord multiplication between two subsets of the cyclic group Z/nZ" :icon 421
    :icon 420 
  (mapcar 
   #'(lambda (a1)
...
(defmethod! get-tid ((n integer))
  :initvals '(12) :indoc '("n")
  :doc "It gives the collection of the idempotent chords inside of the division of the octave in n parts i.e. the collection of all subgroups of the cyclic group Z/nZ  " 
  :icon 420 
...
(defmethod!  TL-ZN ((n integer))
  :initvals '(12) :indoc '("n")
  :doc "It gives the collection of modes with the Messiaen property of limited transposition inside of the division of the octave in n parts  " 
  :icon 420 
  (remove-dup (t-primeform-n (remove (arithm-ser 0 (- n 1) 1) 
                                     (remove-dup 
